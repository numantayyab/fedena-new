...
class UserController < ApplicationController
  ...
  before_filter :login_required, :except => [:forgot_password, :login, :set_new_password, :reset_password, :new_dashboard,:about_us,:gallery]
  ...
  def choose_layout
    return 'login' if action_name == 'login' or action_name == 'set_new_password' #or action_name == 'new_dashboard'
    return 'forgotpw' if action_name == 'forgot_password'
    return 'dashboard' if action_name == 'dashboard' or action_name == 'new_dashboard' or action_name == 'about_us' or action_name == 'gallery'
    'application'
  end
  ...
  def new_dashboard
    ...
    puts "aaaaaaaaaaaaaaaaaa", request.domain, current_subdomain.inspect
    #login
  end

  def about_us
    @sub_domain = current_subdomain
    puts "bbbbbbbbbbbbbbb", request.domain, current_subdomain.inspect
    #login
  end
  def gallery
    @sub_domain = current_subdomain
