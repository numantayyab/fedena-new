class FinanceController < ApplicationController
  ...
  def master_fees
    ...
    @batchs = Batch.same_school.all.map{|b| b if b.is_deleted == false and b.is_active == true}#.active#.same_school
  ...
  def master_category_new
    @finance_fee_category = FinanceFeeCategory.new
    @batches = Batch.same_school.all.map{|b| b if b.is_deleted == false and b.is_active == true}#.active#.same_school
    respond_to do |format|
