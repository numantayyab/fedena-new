Given "I have a rails application" do
  steps %{
    ...
    Given I save the following as "app_p/models/user.rb"
      """
    ...
    And I save the following as "config/s3.yml"
      ...
      bucket: paperclip
      """
    And I save the following as "app_p/views/users/new.html.erb"
      """
      ...
      <% end %>
      """
    And I save the following as "app_p/views/users/show.html.erb"
      """
      <p>Name: <%= @user.name %></p>
